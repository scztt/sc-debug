...
unsigned char* dumpOneByteCode(PyrBlock *theBlock, PyrClass* theClass, unsigned char *ip)
{
	...
	switch (op1) {
		...
		case  99 : post("       PushSpecialValue 0\n");		break;
		case 100 : post("       PushSpecialValue 1\n");		break;
		case 101 : post("       PushSpecialValue 2\n");		break;
		case 102 : post("       PushSpecialValue 0.5\n");		break;
		case 103 : post("       PushSpecialValue -1.0\n");		break;
		case 104 : post("       PushSpecialValue 0.0\n");		break;
		case 105 : post("       PushSpecialValue 1.0\n");		break;
		case 106 : post("       PushSpecialValue 2.0\n");		break;
		case 107 : post("       PushOneAndAdd\n");				break;
		case 108 : post("       PushSpecialValue true\n");		break;
		...
		case 242 : post("       BlockReturn\n"); break;	// BlockReturn
		case 243 : post("       Return\n"); break;	// Return
		case 244 : post("       ReturnSelf\n"); break; // ReturnSelf
...
bool detectSendSelectorIn(PyrBlock *theBlock, PyrSymbol *testSelector)
{
	...
	bool res = false;
	while (ip<ipend) {
		if ((res = detectSendSelector(theBlock, theClass, &ip, testSelector))) break;
	}
	return res;
}
...
const char* byteCodeString(int code)
{
		switch (code) {
			...
			case 1 : return "PushInstVarX";
			case 2 : return "PushTempVarX";
			case 3 : return "PushTempZeroVarX";
			case 4 : return "PushLiteralX";
			case 5 : return "PushClassVarX";
			case 6 : return "PushSpecialClass";
			case 7 : return "StoreInstVarX";
			case 8 : return "StoreTempVarX";
			case 9 : return "StoreClassVarX";
			case 10 : return "SendMsgX";
			case 11 : return "SuperMsgX";
			case 12 : return "SendSpecialMsgX";
			case 13 : return "SendSpecialUnaryArithMsgX";
			...
			case  99 : return "PushSpecialValue 0";
			case 100 : return "PushSpecialValue 1";
			case 101 : return "PushSpecialValue 2";
			case 102 : return "PushSpecialValue 0.5";
			case 103 : return "PushSpecialValue -1.0";
			case 104 : return "PushSpecialValue 0.0";
			case 105 : return "PushSpecialValue 1.0";
			case 106 : return "PushSpecialValue 2.0";
			case 107 : return "PushOneAndAdd";
			case 108 : return "PushSpecialValue true";
			...
			case 242 : return "BlockReturn";	// BlockReturn
			case 243 : return "Return";	// Return
			case 244 : return "ReturnSelf"; // ReturnSelf
			...
			case 250 :  return "JumpIfFalsePushFalse"; // JumpIfFalsePushFalse
			case 251 :  return "JumpIfTruePushTrue"; // JumpIfTruePushTrue
